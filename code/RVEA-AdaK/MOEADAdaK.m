...
%--------------------------------------------------------------------------
    ...
    methods
        function main(Algorithm,Problem)
            ...
            fstep=0.05;
            flast=0.9;
            Archive=Population.objs; % 源代码及原文中都是直接选择
            Wadapt=W;
...
%                     Offspring = OperatorGAhalf(Problem,Population(P(1:2)));
                    Offspring = OperatorGAhalf(Problem,Population(P(1:2)),{1,20,100,20});
                    ...
                    AdaK(A, Q, P, Wadapt, W, N, zmin, fstep, flast, generations, max_generations, flag, [], false, false, [], [], []);
                end
