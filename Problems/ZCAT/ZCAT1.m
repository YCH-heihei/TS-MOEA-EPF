...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function Setting(obj)
            ...
            obj.m=obj.M-1;
            % 论文中的默认参数: obj.ParameterSet(3,0,0,1,1)
...
%             PopObj=PopObj.*((1:M).^2);
            ...
            if(obj.complicatedParetoSet==0)
                ...
                PopDec(:,m+1:n)=PopDec(:,m+1:n)-g4(PopDec(:,1:m),n);
            end
        ...
        function R = GetOptimum(obj,N)
         % the sampled points 3-objective ZCAT  as follow:
            if(obj.M==3||obj.M==2)
                ...
                tempPath=strcat(datePath,'\','ZCAT1','\','ZCAT1','_M',num2str(obj.M),'_Num',num2str(N),'.mat');
                load(tempPath);
                R=opt;
            else
                R=[];
