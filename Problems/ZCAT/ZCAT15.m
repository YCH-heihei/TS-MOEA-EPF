...
%             obj.K=obj.ParameterSet(3);
        ...
        function PopObj = CalObj(obj,PopDec)
            ...
            PopObj=PF15OfZCAT(PopDec(:,1:m),3);
...
%             PopObj=PopObj.*((1:M).^2);
            ...
            if(obj.complicatedParetoSet==0)
                ...
                PopDec(:,m+1:n)=PopDec(:,m+1:n)-g8(PopDec(:,1:m),n);
            end
        ...
        function R = GetOptimum(obj,N)
         % the sampled points 3-objective ZCAT  as follow:
            if(obj.M==3||obj.M==2)
                ...
                tempPath=strcat(datePath,'\','ZCAT15','\','ZCAT15','_M',num2str(obj.M),'_Num',num2str(N),'.mat');
                load(tempPath);
                R=opt;
            else
                R=[];
